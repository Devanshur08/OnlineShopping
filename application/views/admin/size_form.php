                            ...
                            <div class="card-body collapse in">
                                <div class="card-block ">
                                    ...
                                    <form class="form-horizontal" method="post"
                                        action="<?php echo base_url(); ?>admin/insert_size" novalidate>
                                        <?php }else {?>
                                        <form class="form-horizontal" method="post"
                                            action="<?php echo base_url(); ?>admin/update_size/<?php echo $size_data->size_id_pk;?>"
                                            novalidate>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <h5>Size Name <span class="required">*</span></h5>
                                                        <div class="controls">
                                                            <?php if ($operation == 'insert'){ ?>
                                                            ...
                                                            <input type="text" name="size_name"
                                                                value="<?php echo $size_data->size_name; ?>"
