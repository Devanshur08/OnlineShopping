                            ...
                            <div class="card-body collapse in">
                                <div class="card-block ">
                                    ...
                                    <form class="form-horizontal" method="post"
                                        action="<?php echo base_url(); ?>admin/insert_product_type" novalidate>
                                        <?php }else {?>
                                        <form class="form-horizontal" method="post"
                                            action="<?php echo base_url(); ?>admin/update_product_type/<?php echo $product_type_data->pt_id_pk;?>"
                                            novalidation>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" name="pt_name"
                                                                value="<?php echo $product_type_data->pt_name; ?>"
