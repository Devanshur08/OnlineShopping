                    ...
                    <div class="mobile-menu-area d-block d-lg-none">
                        <div class="mobile-menu">
                            <nav id="mobile-menu-active">
                                <ul>
                                    <li><a href="<?php echo base_url(); ?>user/shop">Special Offers</a></li>
                        ...
                        <div class="col-lg-3 order-2 order-lg-1">
                            ...
                            <div class="filter-wrapper pt-100">
                                ...
                                <div class="filter-wrap">
                                        ...
                                        <a href="#"><img alt="" src="<?php echo base_url(); ?>user_content/img/banner/4.jpg"></a>
                                    </div>
                                </div>
                                <!-- filter-wrap end -->
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="<?php echo base_url(); ?>user/single_product">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/2.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/1.jpg" alt="">
                                                            </a>
                                                        ...
                                                        <div class="product-caption">
                                                            <h4 class="product-name"><a href="<?php echo base_url(); ?>user/single_product">Simple Product 003</a></h4>
                                                            <div class="price-box">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/3.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/4.jpg" alt="">
                                                            </a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/9.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="action-links">
                                                                <a href="#" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/12.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/11.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/12.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="action-links">
                                                                <a href="#" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/13.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                                <a href="#" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/10.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/19.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/17.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/18.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="action-links">
                                                                <a href="#" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/20.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                                <a href="#" class="wishlist-btn" title="Add to Wish List"><i class="icon-heart"></i></a>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/21.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product-area mt-30">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/23.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                            <div class="label-product label_sale">Sale!</div>
                                                            <div class="action-links">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/5.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/6.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="product-thumb">
                                                            <a href="single-product.html">
                                                                <img class="primary-image" src="<?php echo base_url(); ?>user_content/img/product/18.jpg" alt="">
                                                                <img class="secondary-image" src="<?php echo base_url(); ?>user_content/img/product/20.jpg" alt="">
                                                            </a>
                                                            <div class="label-product label_new">New</div>
                                                        </div>
                                                    </div>
